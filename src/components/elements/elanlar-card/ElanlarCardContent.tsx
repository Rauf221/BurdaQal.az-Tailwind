import { Bath, Bed, DoorClosed, MapPin } from "lucide-react";
    ...
    >
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-1">
          <MapPin
            className="h-3 w-3 shrink-0 text-[#636366]"
            strokeWidth={1.5}
            aria-hidden
          />
        ...
        <div className="flex flex-wrap items-center gap-x-2.5 gap-y-1">
          ...
          <span className="h-4 w-px shrink-0 bg-[#aeaeb2]" aria-hidden />
          <div className="flex items-center gap-1.5 text-[#636366]">
            <DoorClosed className="h-4 w-4 shrink-0" strokeWidth={1.5} aria-hidden />
            <span className="text-[14px] font-normal leading-5">

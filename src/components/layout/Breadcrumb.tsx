...
export default function Breadcrumb() {
  ...
  const bgImage = rawBg ? resolveMediaUrl(apiBase(), rawBg) : FALLBACK_BG;

  return (
    <>
      <div className="h-5" aria-hidden />
      <section
        className="relative z-20 overflow-hidden rounded-[24px] bg-cover bg-center bg-no-repeat px-[14px] py-16 text-center md:min-h-[570px] md:bg-fixed md:py-24 lg:pt-[241px] lg:pb-[248px]"
